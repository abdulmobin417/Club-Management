                ...
                <div class="text-gray-700">
                  <div class="grid md:grid-cols-2 text-sm">
                    <div class="grid grid-cols-2">
                      ...
                      <input type="text" name="firstName" class="px-4 py-2 bg-white" value="<?php echo $userData['FirstName']; ?>">
                    </div>
                    <div class="grid grid-cols-2">
                      <div class="px-4 py-2 font-semibold">Last Name</div>
                      <input type="text" name="lastName" class="px-4 py-2 bg-white" value="<?php echo $userData['LastName']; ?>">
                    </div>
                    <div class="grid grid-cols-2">
                    ...
                    <div class="grid grid-cols-2">
                      ...
                      <input type="text" name="phone" class="px-4 py-2 bg-white" value="<?php echo $userData['phone']; ?>">
                    </div>
                    <div class="grid grid-cols-2">
                    ...
                    <div class="grid grid-cols-2">
                      ...
                      <input type="email" name="email" class="px-4 py-2 bg-white" value="<?php echo $userData['email']; ?>">
                    </div>
                    <div class="grid grid-cols-2">
                      <div class="px-4 py-2 font-semibold">Password</div>
                      <input type="password" name="password" class="px-4 py-2 bg-white" value="<?php echo $userData['password']; ?>">
                    </div>
                  </div>
                </div>
                <button
                  type="submit"
                  class="block bg-gray-100 w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-200 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4"
                >
